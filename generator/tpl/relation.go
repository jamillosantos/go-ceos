...
func RenderRelation(_buffer io.StringWriter, env *models.Environment, relation *models.Relation) {
	...
	_buffer.WriteString(gorazor.HTMLEscape(relation.LocalModelType))
	_buffer.WriteString("][]")
	...
	_buffer.WriteString(gorazor.HTMLEscape(relation.LocalColumn))
	...
	_buffer.WriteString(gorazor.HTMLEscape(PascalCase(relation.LocalColumn)))
	_buffer.WriteString("(record)\n\t\t}\n\t}\n\treturn nil\n}\n\nfunc (q ")
	_buffer.WriteString(gorazor.HTMLEscape(Pointer))
	_buffer.WriteString(gorazor.HTMLEscape(relation.Query.Name))
