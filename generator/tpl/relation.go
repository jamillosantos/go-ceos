...
func RenderRelation(_buffer io.StringWriter, relation *models.ModelRelation) {
	...
	_buffer.WriteString("\n}\n\nfunc New")
	_buffer.WriteString(gorazor.HTMLEscape(relation.RelationName()))
	_buffer.WriteString("(conn ceous.Connection) ")
	_buffer.WriteString(("*"))
	_buffer.WriteString(gorazor.HTMLEscape(relation.RelationName()))
	_buffer.WriteString(" {\n\treturn ")
	_buffer.WriteString(("&"))
	...
	_buffer.WriteString(("*"))
	_buffer.WriteString(gorazor.HTMLEscape(relation.RelationName()))
	_buffer.WriteString(") Realize() error {\n\trecords, err := NewUserQuery(ceous.WithConn(relation.conn)).Where(ceous.Eq(Schema.")
	...
	_buffer.WriteString(gorazor.HTMLEscape(relation.RelationName()))
	_buffer.WriteString("(q.BaseQuery.Connection))\n\treturn q\n}")
